...
export interface Transaction {
    ...
    partner_id: string;
    reference: string;
    type: 'wallet_funding' | 'wallet_credit' | 'wallet_debit' | 'p2p_transfer' | 'bank_transfer' | 'ussd_payment' | 'qr_payment' | 'split_payment' | 'fee_deduction' | 'reversal' | 'settlement_payout';
...
export interface ComplianceStatus {
    overall_status: 'incomplete' | 'submitted' | 'under_review' | 'approved' | 'rejected' | 'suspended';
    cac_number: string;
...
export declare class PayKoreError extends Error {
